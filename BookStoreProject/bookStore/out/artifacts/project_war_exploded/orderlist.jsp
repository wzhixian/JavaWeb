		...
		<table width="100%" border="0" cellspacing="0">
			<tr>
				<td width="25%"><table width="100%" border="0" cellspacing="0"
						...
						<tr>
							<td class="listtd"><img src="images/miniicon.gif" width="9"
								height="6" />&nbsp;&nbsp;&nbsp;&nbsp; <a
								href="myAccount.jsp">用户信息修改</a>
							</td>
						</tr>

						<tr>
							<td class="listtd"><img src="images/miniicon.gif" width="9"
								height="6" />&nbsp;&nbsp;&nbsp;&nbsp; <a href="orderServlet">订单查询</a>
							</td>
						</tr>
						<tr>
							<td class="listtd"><img src="images/miniicon.gif" width="9"
								height="6" />&nbsp;&nbsp;&nbsp;&nbsp; <a href="exitServlet">用戶退出</a></td>
						</tr>
				...
				<c:forEach items="${list }" var="l">
									<tr>
										<td class="tableopentd02">${l.id }</td>

										<td class="tableopentd02">${l.receiverName }</td>
										<td class="tableopentd02">${l.ordertime }</td>
										<td class="tableopentd02">${l.paystate==0?"未支付":"已支付" }</td>
										<td class="tableopentd03"><a href="lookOrderServlet?id=${l.id }">查看</a>&nbsp;&nbsp;
											<a href="deleteOrderServlet?id=${l.id }">刪除</a>
										</td>
									</tr>
									</c:forEach>
								</table>
