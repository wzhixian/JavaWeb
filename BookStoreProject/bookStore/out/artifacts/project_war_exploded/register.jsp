...
<script type="text/javascript">
	...
	function ckEmail(){
		...
		xhr.open("get","${pageContext.request.contextPath}/servlet/ckServlet?email="+email.value);
	...
	function ckUsername(){
		...
		xhr.onreadystatechange=function(){
		 if(xhr.readyState==4){
		 	if(xhr.status==200){
		 		var font=document.getElementsByTagName("font")[0]
		 		if(xhr.responseText=="true"){
		 			font.innerHTML="会员名已被占用";
		 			font.style.color="red";
		 		}else{
		 			font.innerHTML="会员名可以使用";
		 			font.style.color="green";
		 		}
		 	}
		 }
		...
		xhr.open("get","${pageContext.request.contextPath}/servlet/ckServlet?username="+username.value);
