...
<div class="dtree">
	...
	<script type="text/javascript">
		...
		d = new dTree('d');
		d.add(0,-1,'系统菜单树');
		d.add(1,0,'商品管理','/project/admin/login/welcome.jsp','','mainFrame');
		d.add(2,0,'订单管理','/project/admin/login/welcome.jsp','','mainFrame');
		
		
		//子目录添加
		d.add(11,1,'商品查看','/project/admin/products/list.jsp','','mainFrame');
		
	
		
		d.add(21,2,'订单查看','/project/admin/orders/list.jsp','','mainFrame');
