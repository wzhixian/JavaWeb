...
<body>
	<br>
	<form id="Form1" name="Form1" action="${pageContext.request.contextPath}/showOrderListByAdminServlet" method="post">
			...
			<TBODY>
				...
				<tr>
					<td class="ta_01" align="center" bgColor="#f5fafe">
						...
						<c:forEach items="${admin_cx_list }" var="ad">
							<tr onmouseover="this.style.backgroundColor = 'white'"
								onmouseout="this.style.backgroundColor = '#F5FAFE';">
								<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									width="20%">${ad.id }</td>
								<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									width="10%">${ad.receiverName }</td>
								<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									width="15%">${ad.receiverAddress }</td>
								<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									width="10%">${ad.receiverPhone }</td>
								<td style="CURSOR: hand; HEIGHT: 22px" align="center">
									${ad.money }</td>
								<td width="8%" align="center">${ad.user_id }</td>
								<td width="10%" align="center">${ad.paystate }</td>

								<td align="center" style="HEIGHT: 22px"><a
									href="${pageContext.request.contextPath}/orderMessageByAdminServlet?id=${ad.id}">
										<img
										src="${pageContext.request.contextPath}/admin/images/button_view.gif"
										border="0" style="CURSOR: hand"> </a></td>
								<td align="center" style="HEIGHT: 22px">
										<a
											href="${pageContext.request.contextPath}/deleOrderByAdminServlet?id=${ad.id}">
											<img
