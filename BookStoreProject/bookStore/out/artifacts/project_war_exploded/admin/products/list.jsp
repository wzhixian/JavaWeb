							...
							<c:forEach items="${cx_list }" var="b">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px" width="7%"><a
										href="${pageContext.request.contextPath}/lookBookServlrt?id=${b.id}">
											<img
									...
									<td align="center" style="HEIGHT: 22px" width="7%"><a
										href="${pageContext.request.contextPath}/delServletByAdmin?id=${b.id} ">
											<img
